#Project_聯合知識庫新聞爬蟲
#關鍵字“靜坐“ 時間:20060101~20161111
library("xml2")
library("httr")
url <- 'https://udndata.com/ndapp/Searchdec2007?udndbid=udndata&page=1&SearchString=%C0%52%A7%A4%2B%A4%E9%B4%C1%3E%3D20060101%2B%A4%E9%B4%C1%3C%3D20161111&sharepage=50&select=0&kind=3'
url <- GET(url, set_cookies('JSESSIONID'='6DFECEE39EDC700740FE1141DA212EA6-n1'))
doc <- read_html(url)
